...
defbindings("WTiling", {
    ...
    submap(META.."S", {
        kpress("o", "WTiling.split_at(_, _sub, 'left', true)"),
        kpress("h", "WTiling.split_at(_, _sub, 'left', true)"),

        kpress("u", "WTiling.split_at(_, _sub, 'right', true)"),
        kpress("n", "WTiling.split_at(_, _sub, 'right', true)"),

        kpress("period", "WTiling.split_at(_, _sub, 'top', true)"),
        kpress("c", "WTiling.split_at(_, _sub, 'top', true)"),

        kpress("e", "WTiling.split_at(_, _sub, 'bottom', true)"),
        kpress("t", "WTiling.split_at(_, _sub, 'bottom', true)"),
    }),

    kpress(META.."Shift+s", "WTiling.unsplit_at(_, _sub)"),
})
